...
\newenvironment{exercise}{
    \iow_now:Nx \g_lalu_ans_iow {
        \cs_if_exist:cTF { @exist@LUchapter@\arabic{chapter} }
            {
                \exp_not:N \setcounter{LUsection}{ \int_eval:n { \value{LUchapter} - 1 } }
                \exp_not:N \LUsection
            }
            {
                \exp_not:N \setcounter{section}{ \int_eval:n { \value{chapter} - 1 } }
                \exp_not:N \section
            }
            { \cs:w @LALU@chaptername \cs_end: }
    }
