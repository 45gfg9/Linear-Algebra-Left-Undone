...
\begin{proof}
    ...
    \begin{align*}
        ...
        = \sum_{i=1}^3 \sum_{j=1}^3 g_{ij} a_i b_j. \qedhere
    \end{align*}
\end{proof}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        + (a_2 b_3 - a_3 b_2)\,\vec{e}_2 \times \vec{e}_3 \\
         & = (a_2 b_3 - a_3 b_2)\,\vec{e}_2 \times \vec{e}_3
        + (a_3 b_1 - a_1 b_3)\,\vec{e}_3 \times \vec{e}_1
        + (a_1 b_2 - a_2 b_1)\,\vec{e}_1 \times \vec{e}_2. \qedhere
    \end{align*}
\end{proof}
    ...
    \begin{align*}
        ...
        + (a_3 b_1 - a_1 b_3) c_2 [\vec{e}_1, \vec{e}_2, \vec{e}_3] \\
         ...
         & = \begin{vmatrix}
            ...
            c_1 & c_2 & c_3
        \end{vmatrix}
        [\vec{e}_1, \vec{e}_2, \vec{e}_3]. \qedhere
    \end{align*}
\end{proof}
...
\begin{proof}
    ...
    \[
        ...
        = \frac{|A x_0 + B y_0 + C z_0 + D|}{\sqrt{A^2 + B^2 + C^2}}. \qedhere
    \]
\end{proof}
